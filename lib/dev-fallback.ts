...
export const MOCK_SETTINGS = {
  ...
  heroSubtitle: "Expert Physical Rehabilitation & Sports Therapy in Ipswich, Suffolk. Specialising in advanced recovery techniques and personalised treatment plans.",
  heroImageUrl: null,
  heroImagePath: null,
  ...
  navigationJson: null,
  metaTitle: "Bruno Physical Rehabilitation - Professional Physiotherapy in Ipswich",
  metaDescription: "Professional physiotherapy and sports rehabilitation services in Ipswich, Suffolk.",
  metaKeywords: "physiotherapy, sports rehabilitation, Ipswich, Suffolk",
  ogImageUrl: null,
  ogImagePath: null,
  createdAt: "2025-01-01T00:00:00Z",
