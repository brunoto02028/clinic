    ...
    itens: [
      ...
      },
      {
        ...
        corpo: {
          ...
          pt: "A Plataforma fornece serviços digitais de saúde incluindo: questionários de triagem médica, agendamento de fisioterapia, escaneamento biomecânico dos pés, avaliações posturais, gerenciamento de protocolos de tratamento, prescrições de exercícios, monitoramento de pressão arterial e gerenciamento de documentos. Estes serviços digitais são complementares e não substituem a avaliação clínica presencial por um fisioterapeuta qualificado.",
        },
      },
      {
        n: 3,
  ...
  },
  {
    ...
    itens: [
      ...
      },
      {
        ...
        corpo: {
          en: "Body assessment photos are stored securely with restricted access. Faces are automatically blurred in captured images to protect your identity. Images are used solely for clinical posture analysis and are accessible only to your treating physiotherapist. You may request deletion of your images at any time.",
