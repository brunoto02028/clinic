      ...
      <main className="flex-1 py-12 sm:py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          <section className="bg-muted/30 rounded-lg p-5 space-y-3 text-sm text-muted-foreground">
            <p>
              {isPt
                ? "Bruno Physical Rehabilitation Ltd (\"nós\", \"nosso\") está comprometido em proteger sua privacidade. Esta política explica como coletamos, usamos e protegemos seus dados pessoais quando você visita nosso site (bpr.clinic) ou usa nossos serviços clínicos."
                : "Bruno Physical Rehabilitation Ltd (\"we\", \"our\", \"us\") is committed to protecting your privacy. This policy explains how we collect, use, and safeguard your personal data when you visit our website (bpr.clinic) or use our clinical services."}
            </p>
            <p>
              {isPt
