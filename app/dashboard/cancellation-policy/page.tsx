  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="flex items-center gap-2 text-base">
            <Clock className="h-5 w-5 text-ba1-warn" />
        ...
        <CardContent className="space-y-3 text-sm text-foreground/80 leading-relaxed">
          ...
          <div className="bg-ba1-warn/10 border border-ba1-warn/20 rounded-lg p-4 space-y-2">
            <div className="flex items-start gap-2">
              <AlertTriangle className="h-4 w-4 text-ba1-warn mt-0.5 shrink-0" />
              <div>
                <p className="font-semibold text-ba1-warn">{isPt ? "Aviso de 24 Horas Necessário" : "24-Hour Notice Required"}</p>
                <p className="text-ba1-warn/80 text-xs">{isPt ? "Cancelamentos feitos com menos de 24 horas de antecedência podem incorrer em uma taxa de cancelamento de até 50% do custo da sessão." : "Cancellations made less than 24 hours before the appointment may incur a cancellation fee of up to 50% of the session cost."}</p>
              </div>
            </div>
          </div>
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="flex items-center gap-2 text-base">
            <Clock className="h-5 w-5 text-ba1-health" />
        ...
        <CardContent className="space-y-3 text-sm text-foreground/80 leading-relaxed">
          ...
          <div className="bg-ba1-health/10 border border-ba1-health/20 rounded-lg p-3 mt-2">
            <p className="text-xs text-ba1-health">{isPt ? "Reagendamentos podem ser feitos pelo portal do paciente, na página de detalhes da consulta." : "Reschedules can be made through your patient portal, on the appointment details page."}</p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="flex items-center gap-2 text-base">
            <CreditCard className="h-5 w-5 text-ba1-health" />
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="flex items-center gap-2 text-base">
            <Shield className="h-5 w-5 text-ba1-ok" />
        ...
        <CardContent className="space-y-3 text-sm text-foreground/80 leading-relaxed">
          ...
          <div className="bg-ba1-ok/10 border border-ba1-ok/20 rounded-lg p-3 mt-2">
            <p className="text-xs text-ba1-ok">{isPt ? "Para cancelar sua assinatura, vá em " : "To cancel your membership, go to "}<Link href="/dashboard/membership" className="underline font-semibold text-ba1-ok hover:no-underline">{isPt ? "Planos e Membros" : "Membership & Plans"}</Link>{isPt ? ' e clique em "Cancelar Assinatura".' : ' and click "Cancel Subscription".'}</p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader className="pb-3">
          <CardTitle className="flex items-center gap-2 text-base">
            <Phone className="h-5 w-5 text-ba1-ok" />
