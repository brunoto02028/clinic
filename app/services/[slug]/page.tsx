...
const SERVICE_DATA: Record<string, ServiceData> = {
  ...
  "mls-laser": {
    ...
    related: ["laser-shockwave", "electrotherapy", "therapeutic-ultrasound", "sports-injury"],
  },
  "biohacking-performance": {
    ...
    benefits: [
      ...
      { en: "Longevity & preventive health coaching for healthspan extension", pt: "Coaching de longevidade e saúde preventiva para extensão da vida saudável" },
    ...
    faq: [
      ...
      { q: { en: "Can sessions be done remotely?", pt: "As sessões podem ser feitas remotamente?" }, a: { en: "Yes. Biohacking coaching sessions are available fully online via video call, making this service accessible wherever you are. All data is reviewed digitally and protocols are delivered to your patient portal.", pt: "Sim. As sessões de coaching de biohacking estão disponíveis totalmente online por videochamada, tornando este serviço acessível onde quer que esteja. Todos os dados são revistos digitalmente e os protocolos são entregues no seu portal de paciente." } },
    ],
  ...
  "sleep-longevity-optimisation": {
    ...
    benefits: [
      ...
      { en: "Longevity biomarker coaching — sleep and healthspan connection", pt: "Coaching de biomarcadores de longevidade — ligação sono e expectativa de vida saudável" },
