    ...
    if (existingScreening) {
      ...
      const screening = await prisma.medicalScreening.update({
        ...
        data: {
          ...
          unexplainedWeightLossDetails: body?.unexplainedWeightLossDetails ?? null,
          nightPainDetails: body?.nightPainDetails ?? null,
          traumaHistoryDetails: body?.traumaHistoryDetails ?? null,
          neurologicalSymptomsDetails: body?.neurologicalSymptomsDetails ?? null,
          bladderBowelDysfunctionDetails: body?.bladderBowelDysfunctionDetails ?? null,
          recentInfectionDetails: body?.recentInfectionDetails ?? null,
          cancerHistoryDetails: body?.cancerHistoryDetails ?? null,
          steroidUseDetails: body?.steroidUseDetails ?? null,
          osteoporosisRiskDetails: body?.osteoporosisRiskDetails ?? null,
          cardiovascularSymptomsDetails: body?.cardiovascularSymptomsDetails ?? null,
          severeHeadacheDetails: body?.severeHeadacheDetails ?? null,
          dizzinessBalanceIssuesDetails: body?.dizzinessBalanceIssuesDetails ?? null,
          painLevel: body?.painLevel ?? null,
          painLocation: body?.painLocation ?? null,
          painTypes: body?.painTypes ?? null,
          painPatterns: body?.painPatterns ?? null,
          painImpact: body?.painImpact ?? null,
