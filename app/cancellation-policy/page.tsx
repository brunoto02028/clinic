    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3">
            {settings?.logoUrl ? (
              ...
              <span className="text-xl font-bold text-[#3d5a4a]">{clinicName}</span>
            )}
          </Link>
          <Link href="/dashboard" className="text-sm text-[#4F7361] hover:text-[#3d5a4a] font-medium transition-colors">
            Patient Portal →
          </Link>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 space-y-10">
        ...
        <div className="text-center space-y-3">
          <div className="inline-flex items-center gap-2 bg-[#4F7361]/10 text-[#3d5a4a] px-4 py-1.5 rounded-full text-sm font-medium">
            Last updated: February 2026
          </div>
          <h1 className="font-sora text-3xl sm:text-4xl font-bold text-gray-900 tracking-tight">Cancellation & Refund Policy</h1>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
            <span className="w-8 h-8 rounded-full bg-[#4F7361] text-white flex items-center justify-center text-sm font-bold">1</span>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
            <span className="w-8 h-8 rounded-full bg-[#4F7361] text-white flex items-center justify-center text-sm font-bold">2</span>
            Reschedule Policy
          </h2>
          <div className="bg-gray-50 rounded-2xl p-6 space-y-4 text-gray-700">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
            <span className="w-8 h-8 rounded-full bg-[#4F7361] text-white flex items-center justify-center text-sm font-bold">3</span>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
            <span className="w-8 h-8 rounded-full bg-[#4F7361] text-white flex items-center justify-center text-sm font-bold">4</span>
            Refund Processing
          </h2>
          <div className="bg-gray-50 rounded-2xl p-6 space-y-3 text-gray-700">
            <ul className="space-y-2 text-sm">
              <li className="flex gap-2"><span className="text-[#4F7361]">•</span> Approved refunds are processed via the original payment method (credit/debit card).</li>
              <li className="flex gap-2"><span className="text-[#4F7361]">•</span> Refunds typically appear in your account within 3–5 business days, depending on your bank.</li>
              <li className="flex gap-2"><span className="text-[#4F7361]">•</span> You will receive an email confirmation once your refund has been processed.</li>
              <li className="flex gap-2"><span className="text-[#4F7361]">•</span> Stripe processing fees (if any) are non-refundable.</li>
            </ul>
          </div>
        </section>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
            <span className="w-8 h-8 rounded-full bg-[#4F7361] text-white flex items-center justify-center text-sm font-bold">5</span>
          ...
          <div className="bg-gray-50 rounded-2xl p-6 text-gray-700 text-sm space-y-2">
            ...
            <ul className="space-y-1 ml-4">
              <li className="flex gap-2"><span className="text-[#4F7361]">•</span> Medical emergencies or hospitalisation</li>
              <li className="flex gap-2"><span className="text-[#4F7361]">•</span> Bereavement</li>
              <li className="flex gap-2"><span className="text-[#4F7361]">•</span> Severe weather or transport disruption</li>
            </ul>
            <p className="mt-3">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-bold text-gray-900 flex items-center gap-2">
            <span className="w-8 h-8 rounded-full bg-[#4F7361] text-white flex items-center justify-center text-sm font-bold">6</span>
            Cancellation by {clinicName}
          </h2>
          <div className="bg-gray-50 rounded-2xl p-6 text-gray-700 text-sm space-y-2">
            <p>In the rare event that we need to cancel your appointment, we will:</p>
            <ul className="space-y-1 ml-4">
              <li className="flex gap-2"><span className="text-[#4F7361]">•</span> Notify you as soon as possible via email and/or phone.</li>
              <li className="flex gap-2"><span className="text-[#4F7361]">•</span> Offer you an alternative appointment at your earliest convenience.</li>
              <li className="flex gap-2"><span className="text-[#4F7361]">•</span> Issue a full refund if you prefer not to rebook.</li>
            </ul>
          </div>
        </section>

        {/* Contact */}
        <section className="bg-gradient-to-br from-[#4F7361]/10 to-[#3d5a4a]/10 rounded-2xl p-8 text-center space-y-4">
      ...
      <footer className="border-t mt-12 py-6 text-center text-sm text-gray-500">
        ...
        <div className="flex gap-4 justify-center mt-2">
          <Link href="/" className="hover:text-[#4F7361] transition-colors">Home</Link>
          <Link href="/dashboard" className="hover:text-[#4F7361] transition-colors">Patient Portal</Link>
        </div>
      </footer>
    </div>
  );
