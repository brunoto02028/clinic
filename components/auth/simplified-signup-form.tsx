...
export default function SimplifiedSignupForm({ tenantSlug, tenantName, isPersonal, primaryColor, logoUrl }: SimplifiedSignupFormProps = {}) {
  ...
  // O botão só aparece quando o servidor oferece mesmo o Google.
  const googleDisponivel = useGoogleSignIn();
    ...
    <div className="w-full max-w-md">
      <Card className="border-0 shadow-xl">
        ...
        <CardContent className="space-y-6">
          ...
          {/* Escondido quando o servidor não oferece o Google. O botão existia
              sempre, e sem credencial o clique dava `client_id is required` e
              jogava o paciente numa página de erro que responde 302 com corpo
              vazio: a tela piscava e ele voltava ao mesmo lugar. */}
          {googleDisponivel && (
            <>
              {/* Google Sign-Up */}
              <Button
