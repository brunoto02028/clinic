...
const SHOWCASE_EN: Record<string, ShowcaseEntry> = {
  ...
  screening: { title: "Medical Screening", subtitle: "Complete your medical history form to ensure safe and personalised care", icon: Shield, color: "text-amber-400", bgGradient: "from-amber-500/10 to-yellow-500/10",
    ...
    howItWorks: [ { step: 1, title: "Complete", desc: "Answer the medical screening questions honestly and thoroughly" }, { step: 2, title: "Submit", desc: "Submit the form — it locks for safety and your therapist is notified" }, { step: 3, title: "Review", desc: "Your therapist reviews your screening before your first session" } ] },
};
...
const SHOWCASE_PT: Record<string, ShowcaseEntry> = {
  ...
  screening: { title: "Triagem Médica", subtitle: "Complete seu formulário de histórico médico para garantir atendimento seguro e personalizado", icon: Shield, color: "text-amber-400", bgGradient: "from-amber-500/10 to-yellow-500/10",
    ...
    howItWorks: [ { step: 1, title: "Completar", desc: "Responda as perguntas da triagem médica com honestidade e detalhes" }, { step: 2, title: "Enviar", desc: "Envie o formulário — ele é bloqueado por segurança e o terapeuta é notificado" }, { step: 3, title: "Revisão", desc: "Seu terapeuta revisa sua triagem antes da primeira sessão" } ] },
};
