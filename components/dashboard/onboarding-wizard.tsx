...
const STEPS: OnboardingStep[] = [
  ...
  },
  {
    id: "screening",
    icon: ClipboardList,
    titleEn: "Medical Screening",
    titlePt: "Triagem Médica",
    descEn: "Fill in your medical history so your therapist can prepare your treatment.",
    descPt: "Preencha seu histórico médico para que o terapeuta possa preparar seu tratamento.",
