...
const navigationGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Instagram Studio", href: "/admin/marketing/instagram-studio", icon: Sparkles },
      { name: "Instagram Overview", href: "/admin/marketing/instagram-dashboard", icon: BarChart3 },
      { name: "Content Calendar", href: "/admin/marketing/content-calendar", icon: CalendarRange },
