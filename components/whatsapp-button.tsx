...
export function WhatsAppFloatingButton() {
  ...
  // On the home page the mobile sticky CTA bar (activity 17, C5) occupies the
  // bottom edge — lift the button above it on small screens so they don't overlap.
  ...
  return (
    <a
      ...
      className={`fixed right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-200 group ${
