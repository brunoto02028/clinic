...
## Reteste online (após correção dos 3 pontos fixos) — commit 933efd74, 22/09/2026 — APROVADO
Layout confirmado com as 3 seções fixas ("5 cm above patella", "10 cm above patella", "15 cm above patella"), cada uma só com Left/Right — sem campo de distância livre (0 encontrados no DOM). Salvei 2 medidas: histórico com colunas "5 cm (L / R, Δ)" / "10 cm (L / R, Δ)" / "15 cm (L / R, Δ)" / "Flex / Ext", Δ correto (-2.5/-2.2/-2.3 na 1ª; -3/-2.5/-2.5 na 2ª). Com 1 medida: "Not enough history for a chart yet." em cada card; com 2: os 5 gráficos (5cm/10cm/15cm/Flexão/Extensão) renderizaram com os deltas certos. Console sem erros JS. Fixture (`qa933-online-patient@example.invalid`) apagada, SELECT final confirmou 0 linhas. Screenshots: `screenshots/online-3points-a1-tab-empty.png`, `-a2-form-filled.png`, `-a2-saved.png`, `-a2-history-table.png`, `-a3-charts.png`, `-a3-charts-2points.png`.
