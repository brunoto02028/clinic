...
Evidência: `specs/048-atividade-do-paciente/qa/screenshots/t-4-activity-tab-ana.png` — mostra, do mais recente ao mais antigo: vídeo assistido, exercícios completados, cada um com ícone por tipo e horário relativo.

### 9. Estado vazio ✅
Paciente Isabel Nogueira (`cmsos29lf0003xzh8tvmayawm`, 0 eventos) → "No activity recorded yet."
Evidência: `specs/048-atividade-do-paciente/qa/screenshots/t-4-activity-estado-vazio.png`
...
3. **Modal abriu imediatamente** (screenshot logo após o clique, sem esperar o POST): `specs/048-atividade-do-paciente/qa/screenshots/t-4-video-modal-abriu.png`
...
## Evidências
Screenshots em `specs/048-atividade-do-paciente/qa/screenshots/`: `t-4-activity-tab-ana.png`, `t-4-activity-estado-vazio.png`, `t-4-video-modal-abriu.png`.
