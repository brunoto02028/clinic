...
**Nova atividade:** use o próximo número livre (hoje **055**) com 3 dígitos. Nunca reaproveite número: 011 e 040 aparecem citados em documentos, mas não têm pasta.
...
- **055 — Destravar o 1º uso do personal.** Biblioteca inicial de exercícios, paywall de sessões do aluno, termos do aluno, guia BPR, exercícios × treinos, vocabulário. Depende de 3 decisões do Bruno. Ver `docs/personal-review-2026-09-18.md`.
