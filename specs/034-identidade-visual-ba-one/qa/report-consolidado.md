...
**Screenshots:** `specs/034-identidade-visual-ba-one/qa/screenshots/` — `t-1-sidebar-logo.png`, `t-1-sidebar-fallback-text.png`, `t-1-t-2-dashboard.png`, `t-2-patients-list.png`, `t-2-t-3-patient-detail.png`, `t-2-settings.png`, `t-3-admin-scans.png`, `t-3-clinic-custom-color.png`, `t-3-evidence-report-tab.png`, `t-3-staff-login.png`, `t-4-clinic-default-color.png`, `t-5-public-site.png`, `t-5-email-marketing.png`.
