...
## Critérios de aceite
- [ ] Cálculo de %GC (JP+Siri), BMI, RCQ, massas — testado (unidades).
- [ ] Isolamento: staff só do tenant; aluno só as próprias; outro tenant → 404.
- [ ] Nenhuma tabela existente alterada além do `sex` aditivo no User.
